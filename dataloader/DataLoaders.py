...
def KittiDataLoader(params):
    ...
    image_datasets['train'] = eval(dataset)(train_data_path, train_gt_path,
                                            setname='train', transform=train_transform, norm_factor=norm_factor,
                                            invert_depth=invert_depth, rgb_dir=rgb_dir, rgb2gray=rgb2gray,
                                            fill_depth=fill_depth, flip=flip)
    ...
    dataloaders['train'] = DataLoader(image_datasets['train'], shuffle=False, batch_size=params['train_batch_sz'],
    ...
    image_datasets['val'] = eval(dataset)(val_data_path, val_gt_path,
                                          setname='val', transform=val_transform, norm_factor=norm_factor,
                                          invert_depth=invert_depth, rgb_dir=rgb_dir, rgb2gray=rgb2gray,
                                          fill_depth=fill_depth, flip=flip)
    ...
    image_datasets['selval'] = eval(dataset)(selval_data_path, selval_gt_path,
                                             setname='selval', transform=None, norm_factor=norm_factor,
                                             invert_depth=invert_depth, rgb_dir=rgb_dir, rgb2gray=rgb2gray,
                                             fill_depth=fill_depth, flip=flip)
    ...
    image_datasets['test'] = eval(dataset)(test_data_path, test_gt_path,
                                           setname='test', transform=None,
                                           norm_factor=norm_factor, invert_depth=invert_depth, rgb_dir=rgb_dir,
